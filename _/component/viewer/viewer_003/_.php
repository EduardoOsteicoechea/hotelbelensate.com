	...
	echo '
		...
		>
			...
			>
				...
				height="100%"
				src="' . $this->images_folder . "/desktop/" . $this->hero_data["image_pair"][0][0] . '"
				>
			</div>
			...
			>
				...
				href="'.$this->hero_data["action_button_href"].'"
				>
			...
			>
				...
				height="100%"
				src="' . $this->images_folder . "/desktop/" . $this->hero_data["image_pair"][0][1] . '"
				>
			</div>
			...
			<script type="module">
				import '. $this->page_name . "_" . $this->component_id . "_" . $this->component_class. "_" . 'class from "'.$this->root_folder.'_/component/viewer/viewer_003/_.js"
