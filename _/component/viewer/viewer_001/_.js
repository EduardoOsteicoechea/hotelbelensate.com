...
export default class{
	...
	(
        ...
        image_container_dot_controls_container,
        image_container_dot_controls_container_dot,
	) 
	{
        ...
        this.folder_content_array = folder_content_array;
        ...
        this.image_container_dot_controls_container = document.getElementById(image_container_dot_controls_container);
        this.image_container_dot_controls_container_dot = document.getElementById(image_container_dot_controls_container_dot);
        ...
        this.image_container_dot_controls_container,
        this.image_container_dot_controls_container_dot,
        );      
        };
}