...
)
{
	...
	echo '
		...
		>
            ...
            <div
            id="'. $this->component_id . "_" .'information_container_right_bar"
            class="
            ...
            >
                ...
                id="'. $this->component_id . "_" .'image_container_image"
                class="'.$this->component_class. "_" .'image_container_image"
                src="'. $this->images_folder . $this->hero_data["image_2"].'"
                alt="information_capacity_icon_container_image"
                height="'.$this->hero_data["image_2_height"].';" 
                style="top:'.$this->hero_data["image_2_top"].';left:'.$this->hero_data["image_2_left"].';"
                >
            </div>
