...
import display_card_001_info_pop_up_dialog from "./display_card_001_info_pop_up_dialog.js";

export default function pop_up_info_contact_card_elements(
	root_folder,
	component_id,
	component_class,
	component_folder,
	...
	button.addEventListener("pointerup",()=>{
		display_card_001_info_pop_up_dialog(
			root_folder,
			component_id,
			component_class,
			component_folder,
			...
			calling_component_container,
			heading_text,
			"Contáctanos a través del siguiente número telefónico.",
			"Presiona el siguiente botón para copiarlo.",
			phone_number_text,
			phone_number_text,
		)
	});
