        ...
        $filter = '
            ...
            >
                ...
                >
                    ...
                    <div
                    id="'. $component_id . "_" .'filter_sumary_container_sumary_container_dates_container"
                    class="'. $component_class . "_" .'filter_sumary_container_sumary_container_dates_container '. $component_class . "_" .'filter_sumary_container_sumary_container_item_container"
                    ></div>
                </div>
                ...
                >
                    ...
                    <div
                    id="'. $component_id . "_" .'filter_sumary_container_sumary_container_capacity_container"
                    class="'. $component_class . "_" .'filter_sumary_container_sumary_container_capacity_container '. $component_class . "_" .'filter_sumary_container_sumary_container_item_container"
                    ></div>
                </div>
                ...
                >
                    ...
                    <div
                    id="'. $component_id . "_" .'filter_sumary_container_sumary_container_type_container"
                    class="'. $component_class . "_" .'filter_sumary_container_sumary_container_type_container '. $component_class . "_" .'filter_sumary_container_sumary_container_item_container"
                    ></div>
                </div>
                ...
                >
                    ...
                    <div
                    id="'. $component_id . "_" .'filter_sumary_container_sumary_container_price_container"
                    class="'. $component_class . "_" .'filter_sumary_container_sumary_container_price_container '. $component_class . "_" .'filter_sumary_container_sumary_container_item_container"
                    ></div> 
                </div>
                ...
                >
                    ...
                    <div
                    id="'. $component_id . "_" .'filter_sumary_container_sumary_container_location_container"
                    class="'. $component_class . "_" .'filter_sumary_container_sumary_container_location_container '. $component_class . "_" .'filter_sumary_container_sumary_container_item_container"
                    ></div>
                </div>              
          

                <div
                id="'. $component_id . "_" .'apply_filters_button_container"
                class="'. $component_class . "_" .'apply_filters_button_container"
                >
                    <div
                    id="'. $component_id . "_" .'apply_filters_button"
                    class="'. $component_class . "_" .'apply_filters_button"
                    >
                        Aplicar filtros
                    </div>  
            ...
            <script type="module">
                ...
                (
                    ...
                    "'. $component_id . "_" .'filters",
                        ...
                        "'. $component_id . "_" .'filter_sumary_container",
                            "'. $component_id . "_" .'filter_sumary_container_title",
                            "'. $component_id . "_" .'filter_sumary_container_sumary_container",
                                "'. $component_id . "_" .'filter_sumary_container_sumary_container_item_container",
                                "'. $component_id . "_" .'filter_sumary_container_sumary_container_dates_container",
                                "'. $component_id . "_" .'filter_sumary_container_sumary_container_capacity_container",
                                "'. $component_id . "_" .'filter_sumary_container_sumary_container_type_container",
                                "'. $component_id . "_" .'filter_sumary_container_sumary_container_location_container",
                                "'. $component_id . "_" .'filter_sumary_container_sumary_container_price_container",                                
                        "'. $component_id . "_" .'apply_filters_button_container",
                            "'. $component_id . "_" .'apply_filters_button",
