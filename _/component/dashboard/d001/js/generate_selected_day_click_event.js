...
)
{
	...
	function disable_all_previous_days(component_name, concatenated_day_id_list, index_of_clicked) 
	{
		...
		selected_dates_container_start_date.innerHTML += document.getElementById(concatenated_day_id_list[index_of_clicked]).innerHTML;
...
console.log( month_3_limit[0])
		...
		selected_dates_container_end_date.innerHTML += document.getElementById(concatenated_day_id_list[index_of_final_clicked]).innerHTML;

		selected_dates_container_day_count_container.innerHTML = "(" + (index_of_final_clicked - (index_of_clicked - 1)) + " días).";
		selected_dates_container_total_price_container.innerHTML = ((index_of_final_clicked - (index_of_clicked - 1)) * room_price_by_day) + " USD";
