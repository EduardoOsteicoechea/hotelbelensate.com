...
) 
{
	...
	for (let i = 0; i < children_quantity_input_element.value; i++) {
		...
		input.classList.add("d001_children_age_input");
	...
	close_button.classList.add("d001_children_age_container_close_button");
	...
	accept_button.classList.add("d001_children_age_container_accept_button");
