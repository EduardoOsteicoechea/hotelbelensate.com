import calculate_min_and_max_dates from "./calculate_min_and_max_dates.js";
...
{
	const max_and_min_dates = calculate_min_and_max_dates(data_object);
	// console.log("calculate_min_and_max_dates: ");
	// console.log(max_and_min_dates);
	// console.log("");
