...
(
	...
	window.addEventListener("load", function(){
		...
		children_parameter_container_input.addEventListener("input",(e)=>{
			...
			generate_children_age_container_elements(e.target, children_age_parameter_container, execute_parameter_container_button, search_bar_parameters_values_object);
		});
