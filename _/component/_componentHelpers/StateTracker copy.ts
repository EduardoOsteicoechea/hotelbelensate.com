...
//   trackState(Promise<ComponentState>): void {
...
//     //     this._state = callbackResult;
//     //     resolve(callbackResult);
//     //   } catch (error) {
//     //     console.log("rejecting")
//     //     reject(new ErrorComponentState());
//     //   }
//     // });

//    //  this._state = await resultingState;
//     console.log("from async trackState(resultingState : Promise<ComponentState>): Promise<void>");
//     console.log(this._state);
//   }
// }