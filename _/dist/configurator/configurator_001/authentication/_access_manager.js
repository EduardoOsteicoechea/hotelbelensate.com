...
export default class access_manager {
    constructor(root_folder, page_name, component_id, component_class_name, outer_container) {
        ...
        this._mnfrwk_cookie = [];
        this._login_dasboard = null;
        this._room_management_dashboard = null;
    ...
    generate_login_dashboard() {
        this._login_dasboard = new login_dashboard(this._root_folder, this._page_name, this._component_id, this._component_class_name, this._outer_container);
    }
    generate_rooms_management_dashboard() {
        this._room_management_dashboard = new room_management_dashboard(this._root_folder, this._page_name, this._component_id, this._component_class_name, this._outer_container);
    }
}
