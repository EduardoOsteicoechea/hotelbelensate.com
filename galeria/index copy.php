...
<?php echo page_body($root_folder, "Galería Belensate", $_SESSION); ?>
	<?php new a001("galeria", $root_folder, $_SESSION, "Galería belensate");?>
	<?php new h001($root_folder, "galeria", "galeria", "galería", $_SESSION);?>
	...
	<?php echo page_footer($root_folder, "galeria", $_SESSION); ?>
